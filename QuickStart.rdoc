...
Source: https://docs.sprites.dev/quickstart/

Get up and running with Sprites in 5 minutes

![A bespectacled bird reading a quickstart guide while a small creature sleeps in a tiny bed nearby](https://docs.sprites.dev/images/quickstart.png)
